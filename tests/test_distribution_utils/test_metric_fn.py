...
class TestClass(BaseTestClass):
    def test_metric_fn_weight(self, dist_class, loss_fn):
        ...
        # Call the function
        loss_fn, loss, is_higher_better = dist_class.dist.metric_fn(predt, dmatrix)
    ...
    def test_metric_fn_crps(self, dist_class_crps):
        ...
        # Call the function
        loss_fn, loss, is_higher_better = dist_class_crps.dist.metric_fn(predt, dmatrix)
    ...
    def test_metric_fn_mixture_weight(self, mixture_class, loss_fn):
        ...
        # Call the function
        loss_fn, loss, is_higher_better = mixture_class.dist.metric_fn(predt, dmatrix)
